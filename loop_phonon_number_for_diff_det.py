...
filename = 'pic/3D/phonon_numbers_for_diff_detunings_2'
...
for i in range(len(detuning)):
    ...
    print('\n x: ', n_x_area[i], n_x_area_3D[i])
    print('\n y: ', n_y_area[i], n_y_area_3D[i])
    print()
...
plt.plot(detuning/1e3, n_x_equation, color = 'orange', label = 'x equ')
plt.plot(detuning/1e3, n_y_equation, color = 'cyan', label = 'y equ')
...
print(n_y_area-n_y_area_3D)
print('g:', param.g)
print('mech freqs: ', param.omega_mech)